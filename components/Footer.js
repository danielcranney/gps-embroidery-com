      ...
      <div className="container flex flex-col w-full mx-auto md:flex-row">
        <div className="w-full pr-0 border-0 border-gray-200 md:border-r md:pr-8 md:w-2/3">
          ...
          <p>
            ...
            a tool invented in the service of imperialism and puts it in the
            hands of women and girls on the ground. It is an ongoing political
            response to the reactionary politics of our times, which aims to
            broaden ideas about who-gets-to-write-what-where in and about the
            British landscape
          </p>
        </div>
